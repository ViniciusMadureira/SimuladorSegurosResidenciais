...
namespace SimuladorSegurosResidenciais
{
    public partial class Form1 : Form
    {
        ...
        private void clearFormFields()
        {
            ...
            epvPropertyValue.SetError(mktPropertyValue, "");
            mktPropertyGoodsValue.Text = "";
            epvPropertyGoodsValue.SetError(mktPropertyGoodsValue, "");
            ckbPropertyHasAlarme.Checked = false;
            cbbPropertyCities.SelectedIndex = -1;
            epvPropertyCities.SetError(cbbPropertyCities, "");
            cbbPropertyCities.Text = "";
            cbbPropertyStates.SelectedIndex = -1;
            epvPropertyStates.SetError(cbbPropertyStates, "");
            cbbPropertyStates.Text = "Selecionar";
            mktUserName.Text = "";
            epvUserName.SetError(mktUserName, "");
            mktUserPhone.Text = "";
            epvUserPhone.SetError(mktUserPhone, "");
            mktUserEmail.Text = "";
            epvUserEmail.SetError(mktUserEmail, "");
            mktUserZipCode.Text = "";
            epvUserZipCode.SetError(mktUserZipCode, "");
            mktUserStreet.Text = "";
            epvUserStreet.SetError(mktUserStreet, "");
            mktUserNumber.Text = "";
            epvUserNumber.SetError(mktUserNumber, "");
            mktUserNeighborhood.Text = "";
            epvUserNeighborhood.SetError(mktUserNeighborhood, "");
            mktUserCity.Text = "";
            epvUserCity.SetError(mktUserCity, "");
            mktUserStateAcronym.Text = "";
            epvUserStateAcronym.SetError(mktUserStateAcronym, "");
            mktInsuranceMonthlyPay.Text = "";
            mktInsuranceFranchise.Text = "";
